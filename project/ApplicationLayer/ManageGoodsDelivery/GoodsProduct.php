...
if(isset($_POST['delete'])){
  $goods->goods_deleteProduct($sp_id);   
}

if(isset($_POST['getData'])){
  $output = $goods->goods_showData($sp_id);
  echo $output;
  exit;
}
?>
...
<body bgcolor="#ccd9ff">
  ...
  <table id="inside_part" width="65%" height="75%" align="center">
    <tr> <hr>
      <th align="center" colspan="3">Goods Product</th>
    </tr>
    <tr>
      <td></td>
      <td>Variation: <select id="goods_variation">
    ...
    <tr height="75%">
      <td colspan="3">
        <div id="goods_content" style="height: 90%"></div>
      </td>
    </tr>
    <tr>
      <td><button type="button" name="back" onclick="window.location.href='../ManageUser/SPManageProduct.php'"> Back </button></td>
      <td></td>
      <td align="right"><input id="product_btn" type="button" name="add" onclick="window.location.href='GoodsAddProduct.php'" value="Add Product"></td>
    </tr>
  </table>
...
<script type="text/javascript">
    ...
    $(document).on('change', '#goods_variation', function(){
      var variation = $('#goods_variation').val();
      var search = $('#search_box').val();
