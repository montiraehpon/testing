...
if(isset($_POST['getData'])){
  $output = $goods->goods_viewVariation();
  echo $output;
  exit;
}

$gd_variationn = $_GET['gd_variation'];

if($gd_variationn == "Cosmetic"){
  $name = "Cosmetic";
}
else if($gd_variationn == "Toys"){
  $name = "Toy";
}
else if($gd_variationn == "Stationery"){
  $name = "Stationery";
}
else if($gd_variationn == "Lifestyle"){
  $name = "Life Style";
}
...
<form action="" method="POST">
  ...
  <table width="100%" height="80%" align="center">
    <tr> <hr>
      <th align="center" colspan="3"><h2><?=$name?></h2> <input type="hidden" id="variation" value="<?=$gd_variationn?>"></th>
    </tr>
    <tr>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
    var variation = "<?php echo $_GET['gd_variation']?>";
