...
if(isset($_POST["variation"])){
  $goods->goods_getVariation();  
}

?>
<html>
<head>
  <title>Goods Variation</title>
...
<body bgcolor="#ffcccc">
  ...
  <table id="detail" width="100%" height="70%" align="center">
    <tr>
      <td colspan="4" align="center"><h3>Goods Variation</h3></td>
    </tr>
    <tr align="center" style="height: 90%"> <hr>
      <td><button type="submit" name="variation" value="Cosmetic" style="width: 120px;height: 120px"> Cosmetic <br> <br> <img src="../../images/GUIImages/cosmetic.png" style="width:50px;height:50px;border:0"/>  </button></td>
      <td><button type="submit" name="variation" value="Toys" style="width: 120px;height: 120px"> Toy <br> <br> <img src="../../images/GUIImages/toys.png" style="width:50px;height:50px;border:0"/>  </button></td>
      <td><button type="submit" name="variation" value="Stationery" style="width: 120px;height: 120px"> Stationery <br> <br> <img src="../../images/GUIImages/stationery.png" style="width:50px;height:50px;border:0"/>  </button></td>
      <td><button type="submit" name="variation" value="Lifestyle" style="width: 120px;height: 120px"> Life Style <br> <br> <img src="../../images/GUIImages/lifestyle.png" style="width:50px;height:50px;border:0"/>  </button></td>
    </tr>
    <tr>
