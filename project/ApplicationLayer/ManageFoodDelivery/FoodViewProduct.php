...
$data2 = $food->food_imgView($sp_id,$fd_idd);
$data3 = $food->food_view($sp_id,$fd_idd);
$data4 = $food->food_imgView($sp_id,$fd_idd);
...
<form action="" method="POST">
  ...
  <table id="detail" width="80%" height="80%" align="center">
    <tr> <hr>
      ...
      ?>
      <input type="hidden" name="fd_id" size="30" value="<?php echo $row['fd_id']?>">
    <tr style="height: 90%">
      <td style="width: 65%"><table style="height: 100%">
        ...
        <tr>
          <td>Product Price</td>
          <td>: RM <?=$row['fd_price']?> </td>    
        </tr>
        <tr>
          <td>Quantity</td>
          <td>: <?=$row['fd_quantity']?></td>
        </tr>
        <tr>
          <td>Variation</td>
