...
$data2 = $track->viewDeliveryDetail($sp_id);
...
if(isset($_POST["accept"])){
  $track->acceptDelivery($rn_id,$sp_id);
}
?>
<html>
<head>
...
<body bgcolor="#ffdd99">
  ...
  <table id="detail" width="60%" height="70%" align="center">
    <tr><hr> 
      <td align="center" width="100%"><table id="scd_detail" width="100%" height="100%">
        ...
        ?> 
        <tr>
          <td align="left" width="30%" height="50%">Service Provider Address: </td>
          <td ><?=$row["sp_address"]?></td>
        </tr>
        <tr>
          <td align="left" width="30%">Service Provider Phone Number: </td>
          <td><?=$row["phone_num"]?></td>
        </tr>
        <?php } ?>
      </table>
  ...
  <table width="80%" align="center">
    <tr>
      <td><button type="button" name="back" onclick="window.location.href='RunnerDeliveryList.php'"> Back </button></td>
      <form action="" method="POST">
      <td align="right"><input id="submit_btn" type="submit" name="accept" value="Accept"></td>
      </form>
    </tr>
  </table>
