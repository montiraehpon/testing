...
$data = $track->goods_rpt($sp_id);
$datacheck = $track->goods_rpt_check($sp_id);
?>
<html>
<head>
  <style>
...
<table id="btn" align="center">
    ...
    <tr >
      <td><h2 style="text-align: center; height: 10px">Goods Report</h2></td>
    </tr>
  </table>
  <table id="scd_detail" width="70%" height="70%" align="center" rules="all">
    ...
    $subtotal=0;
      ...
      foreach($data as $row){ 
        ...
        $gd_sale =(($row["sum"] * $quantity) * $row["product_price"]);
        $subtotal += $gd_sale;

    ?>
      <tr>
        <td align="center"><?=$row["product_name"]?></td>
        <td align="center"><?=$gd_qty_sold?></td>
        <td align="center">RM <?=$gd_sale?></td>
      </tr>
    <?php } ?>
    <tr style="height: 5%">
