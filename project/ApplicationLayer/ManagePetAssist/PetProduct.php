...
if(isset($_POST['delete'])){
  $pet->pet_deleteProduct($sp_id);   
}

if(isset($_POST['getData'])){
  $output = $pet->pet_showData($sp_id);
  echo $output;
  exit;
}
?>
...
<body bgcolor="#ccd9ff">
  ...
  <table id="inside_part" width="65%" height="75%" align="center">
    <tr> <hr>
      <th align="center" colspan="3">Pet Product</th>
    </tr>
    <tr>
      <td></td>
      <td>Variation: <select id="pet_variation">
    ...
    <tr height="75%">
      <td colspan="3">
        <div id="pet_content" style="height: 90%"></div>
      </td>
    </tr>
    <tr>
      <td><button type="button" name="back" onclick="window.location.href='../ManageUser/SPManageProduct.php'"> Back </button></td>
      <td></td>
      <td align="right"><input id="product_btn" type="button" name="add" onclick="window.location.href='PetAddProduct.php'" value="Add Product"></td>
    </tr>
  </table>
...
<script type="text/javascript">
    ...
    $(document).on('change', '#pet_variation', function(){
      var variation = $('#pet_variation').val();
      var search = $('#search_box').val();
