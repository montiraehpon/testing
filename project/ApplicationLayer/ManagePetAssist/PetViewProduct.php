...
$data2 = $pet->pet_imgView($sp_id,$pet_idd);
$data3 = $pet->pet_view($sp_id,$pet_idd);
$data4 = $pet->pet_imgView($sp_id,$pet_idd);
...
<form action="" method="POST">
  ...
  <table id="detail" width="80%" height="80%" align="center">
    <tr> <hr>
      ...
      ?>
      <input type="hidden" name="pet_id" size="30" value="<?php echo $row['pet_id']?>">
    <tr style="height: 90%">
    ...
    <tr>
      <td colspan="2"><button type="button" name="back" onclick="window.location.href='PetProduct.php'"> Back </button></td></td>
    </tr>
  </table>
