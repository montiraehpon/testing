...
require_once '../../BusinessServicesLayer/petController/petController.php';//add



$pet = new petController();//add
...
if(isset($_POST['incqty'])){
  ...
  {
    $pet_idd = $_POST['product_id'];//
    $pet_name = $_POST['product_name'];//
    $data5 = $pet->pet_getquantity($pet_idd);//
...
<body bgcolor="#ffcccc">
  ...
  <table id="scd_detail" width="70%" height="70%" align="center">
    ...
    ?>
      ...
      <tr >
        ...
        <input type="hidden" name="type" value="<?php echo $row["type"]?>"><input type="hidden" name="product_quantity" value="<?php echo $row["product_quantity"]?>">
  ...
  <table width="80%" align="center">
    <tr>
      ...
      <td align="right"><form action="" method="POST"><input id="order_btn" type="button" name="order" value="Order Now" onclick="window.location.href='../ManagePetAssist/MakePayment.php?cus_id=<?=$cus_idd?>&total=<?=$subtotal?>';"></form></td>
    </tr>
  </table>
<?php } ?>
