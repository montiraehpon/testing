...
<body bgcolor="#ffffe6">
  ...
  <table id="scd_detail" width="30%" height="72.5%" align="center">
    <tr> <hr>
      <th align="center" colspan="2" style="font-size: 35px">Sign Up</th>
    </tr>
    <tr>
      <th align="center" colspan="2">Be our customer and enjoy now!</th>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td align="center"><input type="text" name="user_type" size="30" value="Customer" readonly> </td>
    </tr>
    <tr>
      <td align="center" colspan="2">By creating this account, you accept our <a href="Terms.php" target="_blank"> Terms of service</a></td>
    </tr>
    <tr>
      <td align="center" colspan="2"> <input type="submit" name="signup" value="Sign Up" style="height: 30px;width: 60px"> </td>
    </tr>
  </table>
  </form>
