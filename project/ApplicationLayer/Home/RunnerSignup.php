...
<body bgcolor="#ffffe6">
  ...
  <table id="detail" style="float: left;width:50%;border-right: 1px solid black;" height="70%">
    <tr> <hr>
      <td align="center" style="font-size:20px">Earn In Your Free Time</td>
    </tr>
    <tr>
      <td style="text-decoration: underline;"> <strong> Requirements: </strong></td>
    </tr>
      <td><ul style="list-style-type:disc;">
        <li>18 years old and above</a></li>
        <li>Malaysian Citizen that stay in Kuantan</a></li>
        <li>Have own transporstation</a></li>
        <li>Valid Malaysian Driver's License</a></li>
        </ul></td>
    <tr>
      <td align="center"><img src="../../images/GUIImages/earn.png" width="200" height="200"></td>
    </tr>
  </table>
  <table id="detail" height="70%" width="50%">
    <tr>
      <th align="center" colspan="2">SIGN UP TO BE A RUNNER</th>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td align="center"><input type="text" name="user_type" size="30" value="Runner" readonly> </td>
    </tr>
    <tr>
  ...
  <table id="detail" height="30%" width="100%">
    ...
    <tr>
      ...
      <td align="center">Sign in, start to deliver and earn!</td>
    </tr>
  </table>
