...
<body bgcolor="#ccd9ff">
  ...
  <table id="detail" width="60%" height="70%" align="center">
    <tr> <hr>
      <td align="center"> <button type="button" style="width: 120px;height: 120px" onclick="window.location.href='../ProvideTrackingAndAnalysis/SPOrderList.php'"> Order List <br> <br> <img src="../../images/GUIImages/clipboard.png" style="width:50px;height:50px;border:0"/>  </button> </td> 
      <td align="center"> <button type="button" style="width: 120px;height: 120px" onclick="window.location.href='../ProvideTrackingAndAnalysis/SPTrackOrder.php'"> Track Order <br> <br> <img src="../../images/GUIImages/track.png" style="width:50px;height:50px;border:0"/>  </button> </td> 
    </tr>
    <tr>
      <td align="center"> <button type="button" style="width: 120px;height: 120px" onclick="window.location.href='SPManageProduct.php'"> Manage Product<br> <br> <img src="../../images/GUIImages/update.png" style="width:50px;height:50px;border:0"/>  </button> </td> 
      <td align="center"> <button type="button" style="width: 120px;height: 120px" onclick="window.location.href='../ProvideTrackingAndAnalysis/SPReport.php'"> Report <br> <br> <img src="../../images/GUIImages/laptop.png" style="width:50px;height:50px;border:0"/>  </button> </td> 
    </tr>
  </table>
