...
<body bgcolor="#ffdd99">
  ...
  <table id="inside_part" width="60%" height="90%" align="center">
    ...
    <tr>
      ...
      <td width="15%"></td>
      <td width="50%" align="left"><input type="text" name="rn_name" size="30" placeholder="Full Name on IC" required></td>
    </tr>
    <tr>
      <td align="right">IC Number * : </td>
      <td></td>
      <td align="left"><input type="text" name="rn_ic" size="30" placeholder="XXXXXXXXXXXX" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))" required></td>
    </tr>
    <tr>
      <td align="right">IC Photo * : <br> (Front and Back in 1 piece of paper) <br> File Extension: .JPG,.JPEG,.PNG</td>
      <td></td>
      <td align="left"><input type="file" name="rn_icpath" required> </td>
    </tr>
    <tr>
      <td align="right">License Photo * : <br> (Front and Back in 1 piece of paper) <br> File Extension: .JPG,.JPEG,.PNG</td>
      <td></td>
      <td align="left"><input type="file" name="rn_licensepath" required> </td>
    </tr>
    <tr>
      <td align="right">Gender: </td>
      <td></td>
      <td align="left"><select name="rn_gender" required>
    ...
    <tr>
      ...
      <td></td>
      <td align="left"><input type="text" name="rn_phone_num" size="30" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))" placeholder="01xxxxxxxx" required></td>
    </tr>
    <tr>
      <td align="right">Address * : </td>
      <td></td>
      <td align="left"><input type="text" name="rn_address" size="30" placeholder="Address" required></td>
    </tr>
