...
<body bgcolor="#98b2e6">
  ...
  <table id="scd_detail" width="50%" height="70%" align="center">
    ...
    <tr>
      <td></td>
      <td>File</td>
      <td>: <a href="GetFile.php?ic=<?=$row['rn_id']?>">IC photo &nbsp;&nbsp;&nbsp;</a> <a href="GetFile.php?license=<?=$row['rn_id']?>">License photo</a></td>
    </tr>
    <tr>
      <td><button type="button" name="back" onclick="window.location.href='AdminViewRunner.php'"> Back </button></td>
